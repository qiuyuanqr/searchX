...
- [待归类] Meta 工程博客 — https://engineering.fb.com/2025/10/17/ai-research/scaling-llm-inference-innovations/ — （原始日期未记录）— 回填补记；正文引用处：一、先划清边界：scale-up vs scale-out（必做的前提校正）
