...
1. ~~下一篇真跑 `/research`（非股票）时看 Step 5.4b 的质证清单是否明显变短、PDF 来源是否不再「未测」~~——**2026-09-23 已在 22 篇存量上核对**：待质证 379→310、Mac mini PDF 全部抽到正文；同时发现修复带出 3 条假「已找到」，见 [2026-09-23 进度记录](2026-09-23-position-price-redline.md) §3–4。
2. ~~stocks-import 那条链路要不要也跑 `check-sources`~~——**2026-09-23 用户判定不需要，关闭。**
